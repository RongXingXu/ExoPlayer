 ...
 * 代表一种媒体格式
 *
 * <p>在构建 formats 时，填充值已知且与正在构建的 formats 类型相关的所有字段。
 * 有关不同类型格式的信息，请参阅 ExoPlayer 的 <a href="https://exoplayer.dev/supported-formats.html">支持格式页面</a>
 *
 * <h2>formats 通用字段</h2>
 *
 * <ul>
 ...
 * </ul>
 *
 * <h2 id="container-formats">容器 formats 相关属性</h2>
 *
 * <ul>
 *   <li>{@link #containerMimeType}
 *   <li>如果容器只包含一种媒体 track，sample formats 属性也可以是相关的，可以设置为描述该track的 sample format。
 *   <li>If the container only contains one track of a given type (possibly alongside tracks of
 *       other types), then fields relevant to that track type can be set to describe the properties
 *       of the track. See the sections below for <a href="#video-formats">video</a>, <a
 *       href="#audio-formats">audio</a> and <a href="#text-formats">text</a> formats.
 * </ul>
 *
 * <h2 id="sample-formats">sample formats 相关属性</h2>
 *
 * <ul>
 *   <li>{@link #sampleMimeType}
 *   <li>{@link #maxInputSize}
 ...
 * </ul>
 *
 * <h2 id="video-formats">视频 formats 相关属性</h2>
 *
 * <ul>
 *   <li>{@link #width}
 *   <li>{@link #height}
 ...
 * </ul>
 *
 * <h2 id="audio-formats">音频 formats 相关属性</h2>
 *
 * <ul>
 *   <li>{@link #channelCount}
 *   <li>{@link #sampleRate}
 ...
 * </ul>
 *
 * <h2 id="text-formats">文本 formats 相关属性</h2>
 *
 * <ul>
 *   <li>{@link #accessibilityChannel}
 * </ul>
...
public final class Format implements Bundleable {
    ...
    * */
     ...
     */
    /*
    * 符合 IETF BCP 47 标签的语言，如果未知或不适用，则为 null。
    * */
    @Nullable
