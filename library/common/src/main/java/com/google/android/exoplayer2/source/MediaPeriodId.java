...
/**
 * 标识 {@link Timeline.Period} 的指定播放。
 *
 * <p>一个{@link Timeline.Period} 可以播放很多次，例如重复播放. 这个类的每个实例都标志一个{@link Timeline.Period}的指定播放
 *
 * <p>在 ExoPlayer 的实现中，{@link MediaPeriodId} 标识了一个 {@code MediaPeriod}。
 */
...
public class MediaPeriodId {
    ...
    * */
     ...
     */
    /*
    * 如果媒体时间段在一个广告组中，则表示该广告组在period内的索引。 否则为{@link C#INDEX_UNSET} 。
    * */
     ...
     */
    /*
    * 如果媒体时间段在一个广告组中，则表示period中广告组单个广告的索引
    * */
     ...
     */
    /*
    * 该media period所属的缓冲窗口序列中的窗口序列号。 如果media period ID 不是缓冲的窗口序列的一部分则为{@link C#INDEX_UNSET} 。
    * */
